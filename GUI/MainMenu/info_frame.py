...
class ManufacturersView(tk.Frame):
    def __init__(self, parent, controller):
        super().__init__(parent, bg="white")
        tk.Label(self, text="Our Manufacturers", font=("Arial", 24, "bold"), bg="white").pack(pady=20)
...
class InfoFrameView(tk.Frame):
    ...
    def create_sidebar(self):
        ...
        self.create_nav_button(sidebar_frame, "Manufacturers", lambda: self.open_page(ManufacturersView))
